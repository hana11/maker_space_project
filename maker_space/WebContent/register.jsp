				...
				<form method="post" action="membercontroller">
					<div class="form-group">
						<div class="form-row">
							...
							<div class="col-md-6">
								<label for="exampleInputLastName">휴대전화번호</label> <input
									class="form-control" name="mobile" type="text"
									aria-describedby="nameHelp" placeholder="휴대전화번호를 입력해주세요">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="form-row">
							...
							<div class = "col-md-4">
								...
								<input class="btn btn-primary btn-block" type="button" class='btn' id='auth' value='인증 코드 발송'>
							</div>
							<div class="col-md-6">
							<br>
								<label for="confirmedEmailCode">인증코드</label> 
								<input class="form-control" name="code" type="text" Placeholder="코드를  입력해주세요">
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="form-row">
							<div class="col-md-6">
								...
								<input class="form-control" name="company" type="text" placeholder="소속회사를 입력해주세요">
							</div>
						</div>
					</div>

...
public class BoardServiceController extends HttpServlet {
	...
	protected void process(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case "getBoardEdit":
				...
				break;
			case "getTop5Boards":
				getTop5Boards(request, response);
				break;
			case "select":
	...
	private void getTop5Boards(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("\n## getTop5Boards 요청 서비스");
